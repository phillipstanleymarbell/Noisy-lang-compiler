...
OBJS		=\
		...
		noisy-lexers-helpers.$(OBJECTEXTENSION)\
		...
		newton-primenumbers.$(OBJECTEXTENSION)\
		newton-tokens.$(OBJECTEXTENSION)\
		newton-lexer.$(OBJECTEXTENSION)                  \
		newton-firstAndFollow.$(OBJECTEXTENSION)         \
...
>>>>>>> 08a10a112d975c07d7dece66983cfc73e91d0495
