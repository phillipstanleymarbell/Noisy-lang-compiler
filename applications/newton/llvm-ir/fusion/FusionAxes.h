...
static inline FusionVector FusionAxesSwap(const FusionVector sensor, const FusionAxesAlignment alignment) {
    ...
    switch (alignment) {
        ...
        case FusionAxesAlignmentPXNZPY:
            result.axis.x = float64_add(result.axis.x, sensor.axis.x);
            result.axis.y = float64_add(result.axis.y, -sensor.axis.z);
            result.axis.z = float64_add(result.axis.z, sensor.axis.y);
            return result;
        case FusionAxesAlignmentPXNYNZ:
            result.axis.x = float64_add(result.axis.x, sensor.axis.x);
            result.axis.y = float64_add(result.axis.y, -sensor.axis.y);
            result.axis.z = float64_add(result.axis.z, -sensor.axis.z);
            return result;
        ...
        case FusionAxesAlignmentPYNXPZ:
            result.axis.x = float64_add(result.axis.x, sensor.axis.y);
            result.axis.y = float64_add(result.axis.y, -sensor.axis.x);
            result.axis.z = float64_add(result.axis.z, sensor.axis.z);
            return result;
        case FusionAxesAlignmentPYNZNX:
            result.axis.x = float64_add(result.axis.x, sensor.axis.y);
            result.axis.y = float64_add(result.axis.y, -sensor.axis.z);
            result.axis.z = float64_add(result.axis.z, -sensor.axis.x);
            return result;
        ...
        case FusionAxesAlignmentPZPYNX:
            result.axis.x = float64_add(result.axis.x, sensor.axis.z);
            result.axis.y = float64_add(result.axis.y, -sensor.axis.y);
            result.axis.z = float64_add(result.axis.z, -sensor.axis.x);
            return result;
